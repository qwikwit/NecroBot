...
namespace PokemonGo.RocketAPI.Console
{
    public class Settings : ISettings
    {
        ...
        public ICollection<KeyValuePair<ItemId, int>> ItemRecycleFilter
        {
            ...
            new KeyValuePair<ItemId, int>(ItemId.ItemUltraBall, 35),
            ...
            new KeyValuePair<ItemId, int>(ItemId.ItemWeparBerry, 20),
            new KeyValuePair<ItemId, int>(ItemId.ItemPinapBerry, 20),
        ...
        public ICollection<PokemonId> PokemonsToEvolve
        {
            get
            {
                ...
                List<PokemonId> defaultPokemon = new List<PokemonId> {
                    PokemonId.Pidgey, PokemonId.Weedle, PokemonId.Caterpie, PokemonId.Rattata
                };
